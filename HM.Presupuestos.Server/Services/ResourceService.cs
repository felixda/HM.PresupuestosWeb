    ...
    public class ResourceService: IResourceService
    {
        ...
        private void CargarRecursosIdiomaEnMemoriaSync(string codigoIdioma)
        {
            try
            {
                ...
                {
                    Console.WriteLine($"[ResourceService] ⏭️ Idioma ya en memoria: {languageCode}");
                    return;
                }
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ Idioma no encontrado en configuración: {languageCode}");
                    return;
                }
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ No se encontró ruta del archivo de recursos para: {languageCode}");
                    return;
                }
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ Archivo de recursos no existe: {fullPathJsonFile}");
                    return;
                }
        ...
        {
            _cacheValoresResueltos.Clear();
            Console.WriteLine("[ResourceService] 🗑️ Caché de valores resueltos limpiada");
        }
        ...
        public string? BuscarUrlMenuPorCodeMenuEnJson(int codigoBuscado)
        {
            try
            {
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ Idioma no disponible para buscar menú: {idioma}");
                    return null;
                }
        ...
        public int ObtenerCodigoMenu(string url)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("[ResourceService] ⚠️ No se pudo obtener JSON del menú");
                    return result;
                }
        ...
        public List<string> ObtenerCodigosIdiomas()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ No se pudo cargar idioma para obtener códigos: {idioma}");
                    return result;
                }
            ...
            try
            {
                ...
                foreach (var languageCode in languageCodeList)
                {
                    try
                    {
                        ...
                        {
                            Console.WriteLine($"[ResourceService] ⚠️ No se encontró configuración para idioma: {languageCode}");
                            continue;
                        }
        ...
        private string ObtenerDescripcionIdioma(string codigoIdioma)
        {
            try
            {
                ...
                {
                    Console.WriteLine($"[ResourceService] ⚠️ No se encontró descripción para idioma {codigoIdioma}, usando fallback");
                    return languageKey;
                }
