...
namespace HM.Presupuestos.Server.ThemeSwitcher {
    ...
    public class ThemeService
    {
        ...
        const string DefaultThemeName = "united";
        ...
        // Initialize to null! to suppress CS8618 (will be assigned externally, e.g., via DI)
        public IThemeChangeRequestDispatcher ThemeChangeRequestDispatcher { get; set; } = null!;
        public IThemeLoadNotifier ThemeLoadNotifier { get; set; } = null!;

        public ThemeService()
        {
            ResourcesReadyState = new ConcurrentDictionary<string, TaskCompletionSource<bool>>();
            ThemeSets = CreateSets(this);
            _activeTheme = DefaultTheme ?? throw new InvalidOperationException("Default theme not found in ThemeSets.");
        }
        ...
        {
            return (ActiveTheme != null) ? GetThemeCssUrl(ActiveTheme) : "";
        }
        public string GetActiveBootstrapThemeCssUrl()
        {
            return (ActiveTheme != null) ? GetBootstrapThemeCssUrl(ActiveTheme) : "";
        }
        ...
        {
            return (ActiveTheme != null) ? GetHighlightJSThemeCssUrl(ActiveTheme) : "";
        }
