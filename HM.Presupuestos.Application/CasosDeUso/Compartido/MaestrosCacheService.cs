...
namespace HM.Presupuestos.Application.CasosDeUso.Compartido
{
        ...
        IOptions<MaestrosCacheOptions> opciones) : IMaestrosCacheService
    {
        ...
        // Claves de caché para los 13 métodos cuasi-estáticos
        ...
        private const string ClaveAlcances = "alcances";
        private const string ClaveDisciplinas = "disciplinas";
        private const string ClaveDiversifiedsNCB = "diversifieds-ncb";
        private const string ClaveObjetivos = "objetivos";
        private const string ClaveTiposCompra = "tipos-compra";
        private const string ClaveDisciplinasGrupos = "disciplinas-grupos";
        private const string ClaveTiposDisciplinas = "tipos-disciplinas";
        ...
        #region Métodos cacheados (catálogos de excepción)

        public Task<List<CodigoDescripcion>> ObtenerAlcances() =>
            ObtenerOCachear(ClaveAlcances, inner.ObtenerAlcances);
        public Task<List<CodigoDescripcion>> ObtenerDiversifiedsNCB() =>
            ObtenerOCachear(ClaveDiversifiedsNCB, inner.ObtenerDiversifiedsNCB);
        public Task<List<CodigoDescripcion>> ObtenerDisciplinas() =>
            ObtenerOCachear(ClaveDisciplinas, inner.ObtenerDisciplinas);
        public Task<List<CodigoDescripcion>> ObtenerTiposCompra() =>
            ObtenerOCachear(ClaveTiposCompra, inner.ObtenerTiposCompra);
        public Task<List<CodigoDescripcion>> ObtenerObjetivos() =>
            ObtenerOCachear(ClaveObjetivos, inner.ObtenerObjetivos);
        public Task<List<CodigoDescripcion>> ObtenerTiposDisciplinas() =>
            ObtenerOCachear(ClaveTiposDisciplinas, inner.ObtenerTiposDisciplinas);
        public Task<List<CodigoDescripcion>> ObtenerDisciplinasGrupos() =>
            ObtenerOCachear(ClaveDisciplinasGrupos, inner.ObtenerDisciplinasGrupos);
