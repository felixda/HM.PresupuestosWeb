...
namespace HM.Presupuestos.Domain.Entidades
{
    public  class ConceptoCondicion : CodigoDescripcion
    {
        ...
        /// <summary>
        ///  Indica para el concepto, sobre qué se hace el cálculo. (1=Neto Venta, 2 = Sobreprima, 0 = Elige el usuario).
        ///  Estos valores se arrastran a PPT_CONDICION_MEDIO y si es 0, el usuario tiene que rellenar si será 1 ó 2 cuando se inserte en esta última tabla
        /// </summary>
